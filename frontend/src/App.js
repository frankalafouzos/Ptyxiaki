...
import OwnerPendingEditsList from './screens/Owner/OwnerPendingEditsList';
import OwnerPendingEditDetail from './screens/Owner/OwnerPendingEditDetail';
      ...
      <Router>
        ...
        <main >
          ...
          <Routes>
            ...
            <Route path="/owner/pending-edit/:id" element={<OwnerProtectedRoute element={<OwnerPendingEditDetail />} />} />
